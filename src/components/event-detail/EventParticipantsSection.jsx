...
export default function EventParticipantsSection({
  ...
  return (
    <div className="card detail-column" data-testid="event-detail-participants">
      ...
      <p className="muted participant-filter-help">
        Filtere nach Teilnahme oder Zahlung. Offene Zahlungen und Prüfungen erkennst du an den
        Statuschips.
      </p>
      ...
      <div className="list detail-list">
        ...
        {filteredEventParticipants.map(participant => (
          <div className="item" data-testid="detail-participant-item" key={participant.id}>
